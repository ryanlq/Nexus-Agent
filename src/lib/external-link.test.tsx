...
const desktopWindow = window as unknown as { nexusAgent?: Window['nexusAgent'] }
const initialHermesDesktop = desktopWindow.nexusAgent

function installDesktopBridge(partial: Partial<Window['nexusAgent']> = {}) {
  desktopWindow.nexusAgent = {
    fetchLinkTitle: vi.fn().mockResolvedValue(''),
    openExternal: vi.fn().mockResolvedValue(undefined),
    ...partial
  } as unknown as Window['nexusAgent']
}
...
afterEach(() => {
  ...
  if (initialHermesDesktop) {
    desktopWindow.nexusAgent = initialHermesDesktop
  } else {
    delete desktopWindow.nexusAgent
  }
})
...
describe('external link helpers', () => {
  ...
  it('deduplicates in-flight title fetches and caches results', async () => {
    ...
    installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['nexusAgent']['fetchLinkTitle'] })
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['nexusAgent']['openExternal'] })
