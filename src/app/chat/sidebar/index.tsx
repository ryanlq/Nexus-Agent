...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/nexus'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('nexus:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('nexus:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
