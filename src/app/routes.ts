...
export const LOOPS_ROUTE = '/loops'
...
export const APP_ROUTES = [
  ...
  { id: 'loops', path: LOOPS_ROUTE, view: 'loops' },
...
// Note: skills/prompts/messaging/artifacts/loops are routed main-pane pages
// (PageSearchShell), not overlays.
