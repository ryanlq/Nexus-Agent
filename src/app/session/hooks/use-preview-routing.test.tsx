...
describe('usePreviewRouting', () => {
  beforeEach(() => {
    ...
    Object.defineProperty(window, 'nexusAgent', {
      configurable: true,
      value: {
  ...
  it('does not infer previews from assistant prose', async () => {
    ...
    expect(window.nexusAgent.normalizePreviewTarget).not.toHaveBeenCalled()
  })
  ...
  it('registers structured tool-result preview targets', async () => {
    ...
    expect(window.localStorage.getItem('nexus.desktop.sessionPreviews.v1')).toContain('./dist/index.html')
  })
