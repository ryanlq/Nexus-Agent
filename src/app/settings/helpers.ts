import type { GatewayConfigRecord, ToolsetInfo } from '@/types/nexus'
...
export function getNested(obj: GatewayConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: GatewayConfigRecord, path: string, value: unknown): GatewayConfigRecord {
...
function personalityOptions(config: GatewayConfigRecord): string[] {
