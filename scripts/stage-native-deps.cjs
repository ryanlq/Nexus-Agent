...
const HAVE_NODE_PTY = fs.existsSync(path.join(APP_ROOT, 'node_modules', 'node-pty'))
const REPO_ROOT = HAVE_NODE_PTY ? path.resolve(APP_ROOT, 'node_modules') : path.resolve(APP_ROOT, '..', 'node_modules')
