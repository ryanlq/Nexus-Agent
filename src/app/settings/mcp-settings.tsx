...
import { getGatewayConfigRecord, type NexusGateway, saveGatewayConfig } from '@/nexus'
import { Wrench } from '@/lib/icons'
import { cn } from '@/lib/utils'
import { notify, notifyError } from '@/store/notifications'
import { $activeSessionId } from '@/store/session'
import type { GatewayConfigRecord } from '@/types/nexus'
...
function getServers(config: GatewayConfigRecord | null): McpServers {
...
export function McpSettings({ gateway, onConfigSaved }: McpSettingsProps) {
  ...
  const saveServer = async () => {
    ...
    try {
      ...
      await saveGatewayConfig(nextConfig)
