...
const SIDEBAR_PINNED_STORAGE_KEY = 'nexus.desktop.pinnedSessions'
const SIDEBAR_AGENTS_GROUPED_STORAGE_KEY = 'nexus.desktop.agentsGroupedByWorkspace'
const PANES_FLIPPED_STORAGE_KEY = 'nexus.desktop.panesFlipped'
